public class MinimumLengthoftringAfterDeletingSimilarEnds {
    ...
    public static void main(String[] args) {
        MinimumLengthoftringAfterDeletingSimilarEnds ob=new MinimumLengthoftringAfterDeletingSimilarEnds();
        System.out.println(ob.minimumLength("ca"));
    }
}

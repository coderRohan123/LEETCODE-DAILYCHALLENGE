public class etEqualSubstringsWithinBudget {
    ...
    public static void main(String[] args) {
        etEqualSubstringsWithinBudget ob= new etEqualSubstringsWithinBudget();
        System.out.println(ob.equalSubstring("abcd", "bcdf", 3));
    }

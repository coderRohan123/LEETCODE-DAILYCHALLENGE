public class RemoveMaxNumberofEdgestoKeepGraphFullyTraversable {
    ...
    public static void main(String[] args) {
        RemoveMaxNumberofEdgestoKeepGraphFullyTraversable ob=new RemoveMaxNumberofEdgestoKeepGraphFullyTraversable();
        System.out.println(ob.maxNumEdgesToRemove( 4, new int[][] {{3,1,2},{3,2,3},{1,1,3},{1,2,4},{1,1,2},{2,3,4}}));
